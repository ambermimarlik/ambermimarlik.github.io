	...
	var CONFIG = (function ($, window) {
		...
		return {
			...
			objContactForm: {
				...
				emailAddress: 'info@ambermimarlik.com' // Email for contact
			},
...
*/
			...
			objGoogleMap : {
				address: 'Atatürk Mh., Gaffarefendi Sk, No:5., İstanbul, Türkiye',			   // City, County
				markers: [
					{'address' : 'Amber Mimarlık, Atatürk Mh., Gaffarefendi Sk, No:5., İstanbul, Türkiye'} // Street
				],
				zoom: 14,							   // 0 - 21	
			...
			objSequence : {
				...
				transitionThreshold: 0,		// Boolean: (true/false). Type: true/false or a number representing milliseconds, Default: false
