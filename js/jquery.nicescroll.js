...
(function (factory) {
  ...
  function getScriptPath() {
    ...
    return (path.split('http://html.webtemplatemasters.com/').length>0) ? path.split('http://html.webtemplatemasters.com/').slice(0,-1).join('http://html.webtemplatemasters.com/')+'/' : '';
  }
